...
public class MazeGenerator {
	...
	private void generateMaze(int cx, int cy) {
		DIR[] dirs = DIR.values();
		Collections.shuffle(Arrays.asList(dirs), new Random(3)); //Add a seed so everytime the method is called, the same maze is made
		for (DIR dir : dirs) {
			//find neighbor cell
			int nx = cx + dir.dx;
			int ny = cy + dir.dy;
	...
	public static void main(String[] args) {
		...
		MazeGenerator maze33 = new MazeGenerator(12, 12);
